            ...
            <TypewriterComponent
              onInit={(typewriter) => {
                typewriter
                  ...
                  .deleteAll()
                  .typeString(
                    "<h1 style='font-size:40px;font-weight: 600;font-family: 'League Gothic', sans-serif;'>Introducing 0R. The all in one solution to ensure efficient and seamless diagnostic process</h1"
                  )
                  .start();
              }}
            ></TypewriterComponent>
